...
Rendering and geometry helpers live in trojanlib/imagelib.py; this module
only adds SEM-texture synthesis and the placement logic.
"""
...
from .imagelib import blur, connected_components, dilate, erode
